...
try {
		Debug.PushSubsStack("AddScheme (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("Complete (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,315);
...
try {
		Debug.PushSubsStack("Delete (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,261);
...
try {
		Debug.PushSubsStack("Delete2 (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,272);
...
try {
		Debug.PushSubsStack("Download (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,219);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","911403269",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("Download2 (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,235);
...
try {
		Debug.PushSubsStack("escapeLink (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,246);
...
try {
		Debug.PushSubsStack("GetBitmap (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,330);
...
try {
		Debug.PushSubsStack("GetBitmapResize (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,341);
...
try {
		Debug.PushSubsStack("GetBitmapSample (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,337);
...
try {
		Debug.PushSubsStack("GetInputStream (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,347);
...
try {
		Debug.PushSubsStack("GetRequest (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,310);
...
try {
		Debug.PushSubsStack("GetString (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,291);
...
try {
		Debug.PushSubsStack("GetString2 (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,296);
...
try {
		Debug.PushSubsStack("Head (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,119);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","911141125",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("Initialize (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,38);
...
try {
		Debug.PushSubsStack("MultipartStartSection (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,179);
...
try {
		Debug.PushSubsStack("PatchBytes (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,97);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","911075596",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("PatchString (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,92);
...
try {
		Debug.PushSubsStack("PostBytes (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,63);
...
try {
		Debug.PushSubsStack("PostFile (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,190);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","911337736",RemoteObject.createImmutable("Cannot send files from the assets folder."),0);
...
try {
		Debug.PushSubsStack("PostMultipart (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,133);
...
try {
		Debug.PushSubsStack("PostString (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,58);
...
try {
		Debug.PushSubsStack("PutBytes (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,80);
...
try {
		Debug.PushSubsStack("PutString (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,75);
...
try {
		Debug.PushSubsStack("Release (httpjob) ","httpjob",16,__ref.getField(false, "ba"),__ref,284);
